...
| [parametric-facade](./parametric-facade/) | all (native + LunchBox / Pufferfish / Weaverbird) | Design and articulate parametric building facades — panelization, louvers/fins, attractor-driven patterns and gradients, perforation/relief, and rationalization — using native and plugin components, no scripting. |
